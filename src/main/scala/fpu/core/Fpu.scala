...
class Fpu extends Module {
  ...
  printf("reducedProdct(0)   : %b\n", reducedProduct(0))
  printf("reducedProdct(1)   : %b\n", reducedProduct(1))
  printf("reducedProdct(2)   : %b\n", reducedProduct(2))
  printf("reducedProdct(3)   : %b\n", reducedProduct(3))
  printf("reducedProdct2(0) : %b\n", reducedProduct2(0))
  printf("reducedProdct2(1) : %b\n", reducedProduct2(1))
  printf("reducedProdct3(0) : %b\n", reduction3.io.out(0))
