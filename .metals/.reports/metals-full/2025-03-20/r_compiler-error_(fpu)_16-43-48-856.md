error id: 458EB6CF72D8CC8FD2CAD42823C0DF3A
file://<WORKSPACE>/src/main/scala/fpu/core/FiveBitsAdder.scala
### scala.ScalaReflectionException: value bNoBias is not a method
...
action parameters:
uri: file://<WORKSPACE>/src/main/scala/fpu/core/FiveBitsAdder.scala
text:
```scala
package fpu.core
...
class FiveBitsAdder extends Module {
    ...
    val aNoBias = io.a.asSInt - 15.S
    val bNoBias = io.b - 

    val sum = aNoBias.asSInt + bNoBias.asSInt
