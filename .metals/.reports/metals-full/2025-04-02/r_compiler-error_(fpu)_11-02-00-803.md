error id: 4AA66D63DDF1A9A059712B8C396BA3E6
file://<WORKSPACE>/src/main/scala/fpu/core/FP32Accumulator.scala
### scala.ScalaReflectionException: value exp is not a method
...
action parameters:
uri: file://<WORKSPACE>/src/main/scala/fpu/core/FP32Accumulator.scala
text:
```scala
package fpu.core
...
class FP32Accumulator extends Module {
  ...
  val shiftAmountReg = RegInit(0.S(9.W))
  shiftAmountReg := shiftAmount

  val shiftDirection = Wire(UInt(1.W))
  shiftDirection := shiftAmountReg(8)
  val shiftAmountAbs = shiftAmountReg.abs.asUInt
...
scala.reflect.api.Symbols$SymbolApi.asMethod(Symbols.scala:240)
	...
	scala.tools.nsc.typechecker.ContextErrors$TyperContextErrors$TyperErrorGen$.MissingArgsForMethodTpeError(ContextErrors.scala:811)
	...
	scala.tools.nsc.typechecker.Typers$Typer.typed(Typers.scala:6335)
